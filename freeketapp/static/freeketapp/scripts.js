        ...
        $.getJSON(endpoint, request_parameters)
            .done(response => {
                    ...
                    for (i = 0; i < response.length; i++) {
                      ...
                      html_content += '<a href="/evento/'+response[i]["fields"]["url_id"]+'"><div class="elemento-busqueda"> <div style="background-image: url(/media/' + response[i]["fields"]["img"] + ')" class="image-busqueda"></div><div class="text-busqueda"><div class="text-main-busqueda"><strong>'+response[i]["fields"]["titulo"]+'</strong></div></div></div></a>'
